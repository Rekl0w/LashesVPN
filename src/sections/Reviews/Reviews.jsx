...
const Reviews = () => {
  ...
  return (
      <div
        className="glide relative overflow-visible -z-50 w-full bg-[#FBFBFB] pb-48"
      ...
      >
        ...
        <div className="glide__track" data-glide-el="track">
          <ul className="glide__slides">
            <li className="glide__slide mb-16">
              <div className="max-w-md h-64 mx-auto border-2 active:border-[#F53838] rounded-xl overflow-hidden flex-col flex p-8">
                <div className="flex items-center">
                  <img
                    className="h-12 w-12 rounded-full"
                    src="../../../public/pngs/person1.png"
                    alt="Avatar of Viezh Robert"
                  />
                  <div className="ml-4">
            ...
            <li className="glide__slide mb-16">
              <div className="max-w-md h-64 mx-auto border-2 active:border-[#F53838] rounded-xl overflow-hidden flex-col flex p-8">
                <div className="flex items-center">
                  <img
                    className="h-12 w-12 rounded-full"
                    src="../../../public/pngs/person2.png"
                    alt="Avatar of Yessica Christy"
                  />
                  <div className="ml-4">
                    <p className="text-sm font-semibold w-[150px] text-gray-800">
                      Yessica Christy
                    </p>
                    <p className="text-sm text-gray-500">Shanxi, China</p>
                  </div>
            ...
            <li className="glide__slide mb-16">
              <div className="max-w-md h-64 mx-auto border-2 active:border-[#F53838] rounded-xl overflow-hidden flex-col flex p-8">
                <div className="flex items-center">
                  <img
                    className="h-12 w-12 rounded-full"
                    src="../../../public/pngs/person3.png"
                    alt="Avatar of Kim Young Jou"
                  />
                  <div className="ml-4">
                    <p className="text-sm font-semibold text-gray-800">
                      Kim Young Jou
                    </p>
                    <p className="text-sm text-gray-500 w-[150px] flex-shrink-0">
                      Seoul, South Korea
                    </p>
                  </div>
                  <div className="flex ml-28">
